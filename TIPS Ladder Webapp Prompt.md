...
3. There should be a data entry page that allows a user to enter: 
    ...
    - The desired real dollar income desired to be produced by the TIPS ladder, both as a base amount for each year covered by the ladder and as optional additional amounts for particular, specified years included in the ladder
